    ...
    <header className="sticky top-0 z-40 transition-all duration-300">
      ...
      <div className="border-b border-[var(--border)]/40 bg-gradient-to-b from-[var(--cream)]/25 via-[var(--background)]/95 to-[var(--background)]/90 backdrop-blur-2xl backdrop-saturate-[1.35] shadow-[0_8px_32px_-12px_rgba(44,40,37,0.14),inset_0_1px_0_0_rgba(255,255,255,0.72)]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          ...
          <div className="hidden md:flex items-center justify-end gap-2.5 flex-1 min-w-0">
            ...
            <div className="flex items-center gap-0.5 rounded-full border border-[var(--border)]/55 bg-gradient-to-b from-white to-[var(--cream)]/70 p-1 pl-1.5 shadow-[inset_0_1px_0_rgba(255,255,255,0.85),0_4px_14px_-4px_rgba(44,40,37,0.12)]">
              ...
              <Link
                ...
                className="p-2.5 rounded-full text-[#25D366] hover:bg-[var(--card)] hover:text-[#128C7E] hover:shadow-sm transition-all duration-200"
          ...
          <div className="relative md:hidden flex-1 flex justify-end items-center gap-0.5">
            <Link
              href={whatsAppHref}
              target="_blank"
              rel="noopener noreferrer"
              className="p-2 rounded-lg text-[#25D366] hover:bg-[var(--cream)] transition-colors duration-200"
              aria-label="Chat on WhatsApp"
            >
            ...
            <button
              type="button"
              onClick={openCart}
              className="relative p-2 rounded-lg text-[var(--foreground)]/88 hover:bg-[var(--cream)] transition-colors duration-200"
              aria-label="Cart"
            >
              ...
              {itemCount > 0 && (
                <span className="absolute top-0.5 right-0.5 min-w-[16px] h-[16px] px-0.5 rounded-full bg-gradient-to-br from-[var(--accent)] to-[var(--accent-hover)] text-white text-[9px] font-bold flex items-center justify-center ring-2 ring-[var(--background)]">
                  {itemCount > 99 ? "99+" : itemCount}
                </span>
              )}
            </button>
