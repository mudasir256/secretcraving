...
const rows: Row[] = [
  ...
  },
  {
    ...
    name: "Sex Toys Strap on Dildo Wearable Sex Toys for Lesbian and Couple, Anal G spot Stimulator Adult Sex Toy, Adjustable Size Sex Toy for Women",
  ...
  {
    id: "studio-line-trio",
    name: "Extendable condom — 8 inches",
    slug: "private-room-studio-line-3-piece-set",
    price: 4000,
    compareAtPrice: 4800,
    categoryId: "wellness",
    subcategory: "Care",
    color: "8 inches · mixed retail",
    files: [
  ...
  },
  {
    ...
    name: "Threaded mace Condom Male Condom Adult Lock fine Ring Crystal Sleeve — 6 inches",
    slug: "classic-glide-large-format",
    price: 4400,
    compareAtPrice: 5400,
    categoryId: "wellness",
    subcategory: "Care",
    color: "6 inches · in stock",
    files: [
  ...
  },
  {
    ...
    description:
      "Sex Toys Strap on Dildo Wearable Sex Toys for Lesbian and Couple, Anal G spot Stimulator Adult Sex Toy, Adjustable Size Sex Toy for Women." +
      foot,
  ...
  },
  {
    ...
    name: "Penis extender sleeve — 8 inch (larger fit)",
    slug: "contour-massage-accessory",
    price: 5200,
    compareAtPrice: 6400,
    categoryId: "accessories",
    subcategory: "Massage",
    color: "8 inch · in stock",
    files: ["61bd38536ac64688f484b6fd5a14dad4_1800x1800.webp"],
    description:
      "Penis extender sleeve sized for a larger 8-inch fit. Delays ejaculation: may help prolong intercourse by reducing sensitivity. Partner satisfaction: textured designs can enhance pleasure for both partners. Enhanced length and girth during use. Follow the fit chart on the pack you receive. Use with water-based lubricant; stop if numbness or pain. Adults 18+ only." +
      foot,
